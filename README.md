[![Runs on Jupyter4NFDI](https://github.com/NFDI-Jupyter/ghactions/actions/workflows/notebooks.yaml/badge.svg?branch=failexample)](https://hub.nfdi-jupyter.de/v2/gh/NFDI-Jupyter/ghactions/failexample)
